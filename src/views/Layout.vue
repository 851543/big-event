    ...
    <el-container>
      ...
      <el-header>
        <div>
          黑马程序员：<strong>
            {{
              userInfoStore.info.nickname && userInfoStore.info.nickname != ""
        ...
        <el-dropdown placement="bottom-end" @command="handleCommand">
          <span class="el-dropdown__box">
            <el-avatar
              :src="
                userInfoStore.info.userPic && userInfoStore.info.userPic != ''
      ...
      <!-- 中间区域 -->
      <el-main>
        <div style="width: auto; height: 570px; border: 1px solid red">
